...
public class RobotLibPIDController {
    ...
    public RobotLibPIDController(double kP, double kI, double kD) {
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
    }

    public RobotLibPIDController(double kP, double kI, double kD, boolean continuous, double inputRange) {
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
    ...
    public RobotLibPIDController(double kP, double kI, double kD, double kILimit) {
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
        this.kILimit = kILimit;
    ...
    public RobotLibPIDController(double kP, double kI, double kD, double kILimit, double kIMaxVal) {
        this.kP = kP;
        this.kI = kI;
        this.kD = kD;
        this.kILimit = kILimit;
    ...
    public RobotLibPIDController(double kP, double kI, double kD, double kILimit, double kIMaxVal, double kPosTolerance,
