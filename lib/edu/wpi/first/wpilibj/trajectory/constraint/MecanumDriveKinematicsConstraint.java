...
/**
 * A class that enforces constraints on the mecanum drive kinematics. This can
 * be used to ensure that the trajectory is constructed so that the commanded
...
public class MecanumDriveKinematicsConstraint implements TrajectoryConstraint {
     ...
     *                                travel at.
     */
    public MecanumDriveKinematicsConstraint(final MecanumDriveKinematics kinematics, double maxSpeedMetersPerSecond) {
