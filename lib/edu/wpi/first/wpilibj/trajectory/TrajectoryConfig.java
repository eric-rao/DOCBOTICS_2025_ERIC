...
public class TrajectoryConfig {
    ...
    /**
     * Adds a differential drive kinematics constraint to ensure that no wheel
     * velocity of a differential drive goes above the max velocity.
     *
    ...
    /**
     * Adds a mecanum drive kinematics constraint to ensure that no wheel velocity
     * of a mecanum drive goes above the max velocity.
     *
     ...
     * a swerve drive goes above the max velocity.
     *
