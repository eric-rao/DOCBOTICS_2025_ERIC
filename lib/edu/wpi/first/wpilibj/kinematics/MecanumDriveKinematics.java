...
import edu.wpi.first.wpilibj.MathSharedStore;
import edu.wpi.first.wpilibj.MathUsageId;
 ...
 * take the Moore-Penrose pseudoinverse of [wheelLocations] and then multiply by
 * [wheelSpeeds] to get our chassis speeds.
 *
 * <p>
...
public class MecanumDriveKinematics {
     ...
     *                              to the physical center of the robot.
     ...
     *                              the physical center of the robot.
     */
    public MecanumDriveKinematics(Translation2d frontLeftWheelMeters, Translation2d frontRightWheelMeters,
            Translation2d rearLeftWheelMeters, Translation2d rearRightWheelMeters) {
        ...
        setInverseKinematics(frontLeftWheelMeters, frontRightWheelMeters, rearLeftWheelMeters, rearRightWheelMeters);
     ...
     *         Sometimes, a user input may cause one of the wheel speeds to go above
     *         the attainable max velocity. Use the
     *         {@link MecanumDriveWheelSpeeds#normalize(double)} function to rectify
     *         this issue.
     */
    public MecanumDriveWheelSpeeds toWheelSpeeds(ChassisSpeeds chassisSpeeds, Translation2d centerOfRotationMeters) {
        ...
        return new MecanumDriveWheelSpeeds(wheelsMatrix.get(0, 0), wheelsMatrix.get(1, 0), wheelsMatrix.get(2, 0),
                wheelsMatrix.get(3, 0));
    }

    /**
     * Performs inverse kinematics. See
     * {@link #toWheelSpeeds(ChassisSpeeds, Translation2d)} for more information.
     *
     * @param chassisSpeeds The desired chassis speed.
     ...
     * given wheel speeds. This method is often used for odometry -- determining the
    ...
    public ChassisSpeeds toChassisSpeeds(MecanumDriveWheelSpeeds wheelSpeeds) {
        ...
        wheelSpeedsMatrix.setColumn(0, 0, wheelSpeeds.frontLeftMetersPerSecond, wheelSpeeds.frontRightMetersPerSecond,
