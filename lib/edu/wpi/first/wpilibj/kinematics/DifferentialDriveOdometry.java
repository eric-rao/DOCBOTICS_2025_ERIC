...
public class DifferentialDriveOdometry {
    ...
    /**
     * Constructs a DifferentialDriveOdometry object with the default pose at the
     * origin.
     *
     * @param gyroAngle The angle reported by the gyroscope.
     */
    ...
    public Pose2d update(Rotation2d gyroAngle, double leftDistanceMeters, double rightDistanceMeters) {
        ...
        var newPose = m_poseMeters
                .exp(new Twist2d(averageDeltaDistance, 0.0, angle.minus(m_previousAngle).getRadians()));
